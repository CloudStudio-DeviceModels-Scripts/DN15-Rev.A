...
# Parsing + Configuration Script – DN15 - Rev. A

This **Parsing + Configuration** script is designed for the **DN15** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – DN15 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **DN15** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
